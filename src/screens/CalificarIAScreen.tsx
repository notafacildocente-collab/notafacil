...
const styles = StyleSheet.create({
  ...
  desempenoChipActivo: { backgroundColor: '#1E3A5F', borderColor: '#1E3A5F' },
  desempenoChipText: { fontSize: 14, fontWeight: '700', color: '#1E3A5F' },
  desempenoChipTextActivo: { color: '#FFFFFF' },
  desempenoNombreInfo: { fontSize: 13, color: '#64748B', marginTop: 10 },

  fotosRow: { flexDirection: 'row', gap: 14, alignItems: 'flex-start', flexWrap: 'wrap' },
  fotoContainer: { alignItems: 'center', position: 'relative' },
  fotoThumb: { width: 96, height: 96, borderRadius: 10, borderWidth: 2, borderColor: '#2563EB' },
  fotoRemove: {
    position: 'absolute', top: -9, right: -9,
    backgroundColor: '#DC2626', borderRadius: 12,
    width: 24, height: 24, justifyContent: 'center', alignItems: 'center',
  },
  fotoRemoveText: { color: '#FFFFFF', fontSize: 11, fontWeight: '700' },
  fotoLabel: { fontSize: 11, color: '#2563EB', fontWeight: '600', marginTop: 6 },
  fotoAgregar: {
  ...
  fotoAgregarIcon: { fontSize: 26 },
  fotoAgregarText: { fontSize: 11, color: '#2563EB', fontWeight: '600', textAlign: 'center', marginTop: 4 },
  ...
  botonAnalizarText: { color: '#FFFFFF', fontWeight: '700', fontSize: 15 },
  ...
  resultadoLabel: { fontSize: 11, fontWeight: '700', color: '#1E3A5F', textTransform: 'uppercase', letterSpacing: 0.5 },
  resultadoNota: { fontSize: 40, fontWeight: '800' },
  resultadoRazonamiento: { fontSize: 13, color: '#475569', lineHeight: 19, marginBottom: 8 },
  detectadoBadge: { backgroundColor: '#DBEAFE', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 7 },
  detectadoText: { fontSize: 13, color: '#1E3A5F', fontWeight: '600' },
  ...
  selectorTexto: { fontSize: 15, color: '#0F172A', fontWeight: '600', flex: 1 },
  selectorPlaceholder: { fontSize: 14, color: '#94A3B8', flex: 1 },
  selectorArrow: { fontSize: 22, color: '#94A3B8' },

  inputNota: {
    borderWidth: 1, borderColor: '#CBD5E1', borderRadius: 8,
    paddingHorizontal: 12, paddingVertical: 12,
    fontSize: 22, fontWeight: '700', color: '#0F172A',
    backgroundColor: '#F8FAFC', marginBottom: 16, textAlign: 'center',
  },
  botonGuardar: {
  ...
  botonRehacerText: { color: '#64748B', fontSize: 14, fontWeight: '600' },
  ...
  modalTitulo: { fontSize: 17, fontWeight: '700', color: '#0F172A', marginBottom: 12 },
  modalBusqueda: {
    borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 8,
    paddingHorizontal: 12, paddingVertical: 10,
    fontSize: 15, marginBottom: 12, backgroundColor: '#F8FAFC', color: '#0F172A',
  },
  modalLista: { maxHeight: 320 },
  modalItem: { paddingVertical: 12, paddingHorizontal: 4, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
  modalItemActivo: { backgroundColor: '#EFF6FF', borderRadius: 8, paddingHorizontal: 8 },
  modalItemNombre: { fontSize: 15, color: '#0F172A', fontWeight: '500' },
  modalItemNombreActivo: { color: '#1E3A5F', fontWeight: '700' },
  modalItemDoc: { fontSize: 11, color: '#94A3B8', marginTop: 2 },
  modalVacio: { textAlign: 'center', color: '#94A3B8', marginTop: 20, fontSize: 14 },
