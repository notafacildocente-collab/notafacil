          ...
          <Stack.Navigator screenOptions={{ headerShown: true, headerTitleAlign: 'center' }}>
            {isSignedIn ? (
              <>
                ...
                <Stack.Screen name="Calificacion" component={CalificacionScreen} options={{ title: 'Calificar', headerBackVisible: true }} />
                <Stack.Screen name="Asistencia" component={AsistenciaScreen} options={{ title: 'Asistencia', headerBackVisible: true }} />
                <Stack.Screen name="Planilla" component={PlanillaScreen} options={{ title: 'Planilla', headerBackVisible: true }} />
